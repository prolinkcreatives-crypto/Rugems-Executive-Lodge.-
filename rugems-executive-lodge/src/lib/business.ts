...
export const BUSINESS = {
  ...
  email: "info@rugemsexecutivelodge.net",
  bookingsEmail: "bookings@rugemsexecutivelodge.net",
  address: {
  ...
  hours: {
    ...
    // Same-day check-in closes at this lodge-local time (24h). Matches the
    // "12:00 PM" end of the display range above — see lodge-time.ts.
    checkInCutoff: { hour: 12, minute: 0 },
  },
  payment: {
    method: "Airtel Money",
...
export const links = {
  ...
  bookingsEmail: `mailto:${BUSINESS.bookingsEmail}`,
...
import locationNewAvondaleAsset from "@/assets/location-new-avondale.webp";
import locationRanchdaleImg from "@/assets/location-ranchdale-entrance.webp";
...
export const LOCATIONS = [
  ...
  },
  {
    ...
    coords: { lat: -15.335291, lng: 28.371247 },
...
export const locationMapEmbed = (slug: LocationSlug) => {
  const loc = getLocation(slug)!;
  return `https://www.google.com/maps?q=${loc.coords.lat},${loc.coords.lng}&hl=en&z=17&output=embed`;
};
