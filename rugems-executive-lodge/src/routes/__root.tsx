  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-6">
      <div className="max-w-md text-center">
        ...
        <Link
          to="/"
          className="inline-flex items-center gap-2 px-8 py-3 rounded-full bg-primary text-on-primary text-label-caps btn-glow hover:[--tw-shadow:var(--shadow-ambient-lg)] hover:-translate-y-0.5 transition-all"
        >
          Return home
        </Link>
      </div>
      ...
      <div className="max-w-md text-center">
        ...
        <div className="flex justify-center gap-3">
          <button
            ...
            className="px-6 py-3 rounded-full bg-primary text-on-primary text-label-caps"
          >
            Try again
          </button>
