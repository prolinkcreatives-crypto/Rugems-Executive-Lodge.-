...
import { WebsiteImagesManager } from "@/components/admin/website-images-manager";
import {
  Dialog,
  DialogContent,
  DialogHeader,
...
function AdminPage() {
  ...
  const [tab, setTab] = useState<"bookings" | "rooms" | "images">("bookings");
    ...
    <>
      ...
      <div className="pt-32 md:pt-40 pb-24 min-h-screen bg-surface">
        <div className="mx-auto max-w-[1400px] px-6 md:px-10">
          ...
          <div className="flex gap-2 mb-8">
            {(
              ...
              <button
                ...
                onClick={() => setTab(t)}
                className={
                  "text-label-caps rounded-full px-6 py-2.5 transition-all duration-300 " +
                  (tab === t
          ...
          {tab === "images" && <WebsiteImagesManager />}
          {tab === "bookings" && (
            <>
