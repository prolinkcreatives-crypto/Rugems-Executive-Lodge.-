...
import heroEntranceAsset from "@/assets/hero-new-avondale-entrance.png";
import receptionLobbyAsset from "@/assets/reception-lobby.png";
    ...
    <section id="visit" className="relative py-32 md:py-48 bg-surface px-6 md:px-16">
      <div className="mx-auto max-w-7xl grid grid-cols-1 md:grid-cols-12 gap-10 items-start">
        <div className="md:col-span-5 flex flex-col gap-6">
          ...
          <Reveal delay={0.2}>
            <div className="flex flex-wrap gap-3 mt-6">
              <a
                href={links.tel}
                className="group inline-flex items-center gap-2 rounded-full bg-primary text-on-primary px-6 py-3 text-label-caps hover:-translate-y-0.5 hover:shadow-ambient-lg transition-all duration-500"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="group inline-flex items-center gap-2 rounded-full border border-outline-variant text-on-surface-variant px-6 py-3 text-label-caps hover:border-primary hover:text-primary transition-all duration-500"
              >
        ...
        <div className="md:col-span-7">
          <Reveal delay={0.1}>
            <div className="relative aspect-[4/3] md:aspect-[16/11] overflow-hidden shadow-ambient-lg gold-hairline bg-ivory p-2">
              <iframe
