...
function Hero() {
  ...
  const heroImage = useSiteImage("homepage-hero", heroEntranceAsset);
...
function Story() {
  const receptionImage = useSiteImage("homepage-reception", receptionLobbyAsset);
  const suitePreviewImage = useSiteImage(
    "homepage-suite-preview",
