      ...
      <div className="pt-32 md:pt-40 pb-24 min-h-screen bg-surface relative overflow-hidden">
        ...
        <div className="mx-auto max-w-3xl px-6 text-center relative z-10">
          <motion.div
            ...
            className="mx-auto mb-10 h-20 w-20 rounded-full bg-primary text-on-primary flex items-center justify-center shadow-ambient-lg"
          >
            <motion.span
              initial={{ scale: 0 }}
              animate={{ scale: 1 }}
          ...
          <Reveal delay={0.4}>
            <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
              <Link
                to="/"
                className="rounded-full bg-primary text-on-primary px-8 py-3.5 text-label-caps hover:-translate-y-0.5 hover:shadow-ambient-lg transition-all duration-500 inline-flex items-center gap-3"
              >
                Return home
              </Link>
              <a
