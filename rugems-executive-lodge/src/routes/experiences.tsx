...
function ExperiencesPage() {
  const heroImg = useSiteImage("experiences-hero", "https://images.unsplash.com/photo-1571508601891-ca5e7a713859?w=2000&q=85");
  const bathImg = useSiteImage("experiences-bath", "https://images.unsplash.com/photo-1552321554-5fefe8c9ef14?w=1400&q=85");
  const readingNookImg = useSiteImage("experiences-reading-nook", "https://images.unsplash.com/photo-1616627981793-ee7d92858c6c?w=800&q=85");
  const diningImg = useSiteImage("experiences-dining", "https://images.unsplash.com/photo-1519821172144-4f87d85de2a4?w=1400&q=85");
  const poolImg = useSiteImage("experiences-pool", "https://images.unsplash.com/photo-1540541338287-41700207dee6?w=1200&q=85");
  const candleImg = useSiteImage("experiences-candle", "https://images.unsplash.com/photo-1602928298849-325cec8771c0?w=800&q=85");
  return (
    <>
      <Nav />
