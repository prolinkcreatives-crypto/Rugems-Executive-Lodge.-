      ...
      <div className="pt-40 pb-24 min-h-screen flex items-center bg-surface">
        ...
        >
          ...
          <form onSubmit={submit} className="space-y-6 mt-8">
            ...
            <button
              disabled={busy}
              className="w-full rounded-full bg-primary text-primary-foreground py-4 text-label-caps hover:-translate-y-0.5 hover:shadow-ambient-lg transition-all duration-500 disabled:opacity-40"
            >
