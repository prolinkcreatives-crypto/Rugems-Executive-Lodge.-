          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            >
              <div className="flex items-center gap-3">
                <span className="inline-flex h-10 w-10 items-center justify-center rounded-full bg-primary text-on-primary">
            ...
            >
              ...
              <button
                ...
                className="group mt-6 inline-flex items-center justify-center gap-3 rounded-full bg-primary text-on-primary px-8 py-4 text-label-caps disabled:opacity-40 disabled:cursor-not-allowed hover:-translate-y-0.5 hover:shadow-ambient-lg transition-all duration-500"
              >
